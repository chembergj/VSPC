...
namespace VSPC.Core.Messages
{
    ...
    public class PositionReportMessage: AMessage
    {
        ...
        {
            return string.Format("PositionReportMessage Lat: {0:##.000000}  Long: {1:##.000000}  TrueAlt: {2:#0000}  Groundspeed: {3:000} Pitch: {4}  Bank: {5}  Heading: {6}  Transponder: {7}", Latitude, Longitude, TrueAltitude, Groundspeed, Pitch, Bank, Heading, Transponder);
        }
    }
}
